...
export function UsersList() {
  ...
  const { data, isLoading, error, refetch, isFetching } = useUsers(filters);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Select
          ...
          onValueChange={(v) =>
            handleFilterChange("role", v === "ALL" ? undefined : v)
          }
        >
          <SelectTrigger>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Total {meta.total} users • Showing {users.length} on this page
          </CardDescription>
        </CardHeader>
        <CardContent>
